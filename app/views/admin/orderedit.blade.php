		...
		<div class="col-md-6">
			<tabset>
				<tab ng-repeat="category in categorys"
					...
					<div >
					<div class="row">
					  <div ng-repeat="item in items" class="col-xs-6 col-md-2 label label-primary" ng-click="addItem(item.id, order.id);" style="white-space: normal; min-height: 60px; margin: 5px;
